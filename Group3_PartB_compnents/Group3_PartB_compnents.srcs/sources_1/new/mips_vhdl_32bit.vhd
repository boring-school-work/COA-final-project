...
architecture Behavioral of mips_vhdl_32bit is
  signal pc_current: std_logic_vector(5 downto 0);
  signal pc_next, pc2: std_logic_vector(5 downto 0);
  ...
  signal sign_ext_im: std_logic_vector(31 downto 0);
  signal read_data2: std_logic_vector(31 downto 0);
  signal ALU_Control: std_logic_vector(2 downto 0);
  signal ALU_out: std_logic_vector(31 downto 0);
  signal zero_flag, sign_flag: std_logic;
  signal PC_j, PC_branch, PC_4branch, PC_4beqj: std_logic_vector(5 downto 0);
  signal mem_read_data: std_logic_vector(31 downto 0);
  signal f1: std_logic;

  component instruction_memory_32bit
    port (
      inst_add: in std_logic_vector(5 downto 0);
  ...
  component ALU_CONTROL_UNIT_32BIT
    port (
...
begin
  ...
  Instruction_Memory: Instruction_Memory_32bit
    port map (
      inst_add => pc_current,
      instruction => instr
    );
  ...
  control: control_unit_32bit
    port map (
      reset => reset,
      opcode => instr(31 downto 26), -- Corrected width for opcode
      reg_dst => reg_dst,
  ...
  register_file: register_file_32bit
    port map (
      clk => clk,
      rst => reset,
  ...
  sign_ext_im <= (others => '0'); -- Initialize the signal
  process(instr)
  begin
    sign_ext_im(15 downto 0) <= instr(15 downto 0);
    sign_ext_im(31 downto 16) <= (others => instr(15));
  end process;

  -- ALU control unit of the MIPS Processor in VHDL
  ALUControl: alu_control_unit_32bit
    port map (
      ALUOp => alu_op,
  ...
  -- PC beq 
  PC_branch <= sign_ext_im(5 downto 0);
