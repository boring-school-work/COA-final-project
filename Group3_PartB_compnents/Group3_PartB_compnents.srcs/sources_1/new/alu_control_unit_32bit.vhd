...
entity ALU_CONTROL_UNIT_32BIT is
  port(
    ...
    ALU_Funct : in std_logic_vector(5 downto 0)  -- 6-bit function code from instruction (extended for 32-bit operations)
  );
end ALU_CONTROL_UNIT_32BIT;

architecture Behavioral of ALU_CONTROL_UNIT_32BIT is
begin
  ...
  begin
    case ALUOp is
      when "000" => 
        -- Use the function code directly for ALU control (lower 3 bits of the 6-bit function code)
